package com.currencyconvertorassignment.usecases

import android.util.Log
import com.currencyconvertorassignment.BuildConfig
...
/**
 * use case class used to handle application Business logic
 */
class CurencyConvertorUseCases  constructor(
